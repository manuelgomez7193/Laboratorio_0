...
${OBJECTDIR}/Clases/CPP/Arribo.o: Clases/CPP/Arribo.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/CPP/Arribo.o Clases/CPP/Arribo.cpp

${OBJECTDIR}/Clases/CPP/Barco.o: Clases/CPP/Barco.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/CPP/Barco.o Clases/CPP/Barco.cpp

${OBJECTDIR}/Clases/CPP/BarcoPasajeros.o: Clases/CPP/BarcoPasajeros.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/CPP/BarcoPasajeros.o Clases/CPP/BarcoPasajeros.cpp

${OBJECTDIR}/Clases/CPP/BarcoPesquero.o: Clases/CPP/BarcoPesquero.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/CPP/BarcoPesquero.o Clases/CPP/BarcoPesquero.cpp

${OBJECTDIR}/Clases/CPP/Puerto.o: Clases/CPP/Puerto.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/CPP/Puerto.o Clases/CPP/Puerto.cpp

${OBJECTDIR}/DataType/CPP/DtArribo.o: DataType/CPP/DtArribo.cpp
	${MKDIR} -p ${OBJECTDIR}/DataType/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataType/CPP/DtArribo.o DataType/CPP/DtArribo.cpp

${OBJECTDIR}/DataType/CPP/DtBarco.o: DataType/CPP/DtBarco.cpp
	${MKDIR} -p ${OBJECTDIR}/DataType/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataType/CPP/DtBarco.o DataType/CPP/DtBarco.cpp

${OBJECTDIR}/DataType/CPP/DtBarcoPasajeros.o: DataType/CPP/DtBarcoPasajeros.cpp
	${MKDIR} -p ${OBJECTDIR}/DataType/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataType/CPP/DtBarcoPasajeros.o DataType/CPP/DtBarcoPasajeros.cpp

${OBJECTDIR}/DataType/CPP/DtBarcoPesquero.o: DataType/CPP/DtBarcoPesquero.cpp
	${MKDIR} -p ${OBJECTDIR}/DataType/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataType/CPP/DtBarcoPesquero.o DataType/CPP/DtBarcoPesquero.cpp

${OBJECTDIR}/DataType/CPP/DtFecha.o: DataType/CPP/DtFecha.cpp
	${MKDIR} -p ${OBJECTDIR}/DataType/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataType/CPP/DtFecha.o DataType/CPP/DtFecha.cpp

${OBJECTDIR}/DataType/CPP/DtPuerto.o: DataType/CPP/DtPuerto.cpp
	${MKDIR} -p ${OBJECTDIR}/DataType/CPP
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataType/CPP/DtPuerto.o DataType/CPP/DtPuerto.cpp
